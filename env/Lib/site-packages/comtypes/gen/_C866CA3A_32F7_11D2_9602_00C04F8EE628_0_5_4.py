...
__all__ = [
    'SpInprocRecognizer', 'SAFT22kHz8BitStereo',
    'DISPID_SOTDisplayUI', 'ISpeechCustomStream', 'SDTLexicalForm',
    'SVEViseme', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPRDisplayAttributes', 'STSF_CommonAppData',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SPAStartElementInResult',
    'eWORDTYPE_ADDED', 'SECNormalConfidence', 'ISpeechVoice',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRGRecoContext',
    'SPAUDIOSTATUS', 'DISPID_SRAudioInput',
    'SAFTCCITT_ALaw_11kHzStereo', 'SAFTCCITT_ALaw_22kHzMono',
    'SRTAutopause', 'SRAImport', 'SAFTNoAssignedFormat',
    'SPLO_STATIC', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_RESERVED4', 'SPEI_RESERVED1', 'SAFT11kHz16BitMono',
    'DISPID_SPEAudioSizeTime', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVEVoiceChange', 'SPINTERFERENCE_TOOLOUD',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_PROPERTY_NUM_CHANGE',
    'SGDisplay', 'DISPID_SpeechMMSysAudio', 'SPEI_START_INPUT_STREAM',
    'STCRemoteServer', 'SpeechRecoContextState',
    'DISPID_SPRNumberOfElements', 'SVP_1', 'SPINTERFERENCE_TOOQUIET',
    'SVP_14', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SpeechAddRemoveWord', 'DISPID_SLGetPronunciations',
    'DISPID_SVSInputWordLength', 'SP_VISEME_8',
    'DISPID_SRCEPhraseStart', 'Speech_Max_Word_Length',
    'SVSFPersistXML', 'SREInterference', 'DISPID_SpeechObjectToken',
    'SPEI_END_SR_STREAM', 'SSFMOpenReadWrite', 'IEnumString',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechLexiconWord',
    'ISpeechTextSelectionInformation', 'DISPID_SOTsItem', 'SPSNoun',
    'SPEI_SOUND_END', 'SAFTADPCM_8kHzMono', 'ISpRecoContext',
    'ISpRecoGrammar2', 'SRERecognition', 'ISpResourceManager',
    'DISPID_SRGCommit', 'ISpRecoContext2', 'SP_VISEME_4',
    'ISpeechGrammarRule', 'SRSEIsSpeaking', 'SpeechEngineConfidence',
    'SpeechUserTraining', 'SpeechVoicePriority',
    'DISPID_SRCEEnginePrivate', 'DISPID_SVEPhoneme', 'SVP_8',
    'DISPIDSPTSI_SelectionOffset', 'SpeechAudioFormatType',
    'DISPID_SVIsUISupported', 'SVP_2', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SPEAudioStreamOffset', 'SpeechStreamFileMode',
    'SpMMAudioOut', 'DISPID_SVSpeak', 'SWPKnownWordPronounceable',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPWT_PRONUNCIATION',
    'SPSMF_UPS', 'SAFTCCITT_uLaw_22kHzMono', 'SASStop',
    'DISPID_SpeechPhraseElements', 'DISPIDSPTSI_ActiveOffset',
    'SPEI_VOICE_CHANGE', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SASState', 'SPTEXTSELECTIONINFO',
    'DISPID_SRCERecognizerStateChange', 'SPPS_Function',
    'DISPID_SRRRecoContext', 'SPPS_LMA', 'SPEI_VISEME',
    'DISPID_SRRTLength', 'SDTReplacement', 'SGLexicalNoSpecialChars',
    'DISPID_SRCRetainedAudio', 'SVPOver', 'eLEXTYPE_PRIVATE15',
    'DISPID_SOTIsUISupported', 'ISpeechLexiconWords', 'SPCT_SLEEP',
    'SVEVoiceChange', 'DISPID_SLGenerationId', 'SpeechRecoEvents',
    'SpShortcut', 'ISpeechLexiconPronunciations',
    'SPINTERFERENCE_NOISE', '__MIDL_IWinTypes_0009',
    'DISPID_SRRPhraseInfo', 'SSSPTRelativeToEnd', 'ISpGrammarBuilder',
    'DISPID_SDKSetLongValue', 'DISPID_SBSWrite',
    'DISPID_SVAlertBoundary', 'eLEXTYPE_PRIVATE10',
    'SpeechVoiceEvents', 'DISPID_SOTDataKey', 'DISPID_SLPType',
    'eLEXTYPE_PRIVATE5', 'ISpeechObjectToken',
    'DISPID_SVSInputSentenceLength', 'SPPS_RESERVED3',
    'SpSharedRecognizer', 'eLEXTYPE_PRIVATE8', 'SVP_3',
    'DISPID_SRCEInterference', 'SAFT48kHz16BitMono',
    'DISPID_SPRuleFirstElement', 'SAFT44kHz8BitStereo',
    'SECFIgnoreKanaType', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SpeechPhraseRule', 'SRSActiveAlways', 'ISpVoice',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVAudioOutput',
    'DISPID_SpeechRecognizer', 'ISpeechGrammarRuleState',
    'SpeechRecoProfileProperties', 'DISPID_SFSOpen', 'SP_VISEME_18',
    'SP_VISEME_15', 'ISpeechPhraseReplacement',
    'ISpObjectTokenCategory', 'SPFM_CREATE_ALWAYS', 'SRCS_Disabled',
    'SBOPause', 'SPRECOGNIZERSTATUS', 'SPWT_DISPLAY',
    ...
    'DISPID_SDKDeleteKey', 'SPSHT_NotOverriden', 'SVP_20',
    'SPPHRASEREPLACEMENT', 'SPVPRI_NORMAL', 'Speech_Max_Pron_Length',
    'DISPID_SRGetFormat', 'ISpeechPhraseReplacements',
    'ISpeechAudioBufferInfo', 'ISpDataKey',
    'DISPID_SpeechObjectTokens', 'DISPID_SGRsCommit',
    'SAFT12kHz16BitStereo', 'SVSFDefault', 'SPSNotOverriden',
    'SPRECORESULTTIMES', 'SGDSActiveWithAutoPause',
    'SPDATAKEYLOCATION', 'SDTAll', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLPsCount', 'SVP_10', 'DISPID_SPIEngineId',
    'SAFTCCITT_uLaw_8kHzMono', 'SINone', 'SpeechAudioFormatGUIDWave',
    'DISPID_SLAddPronunciation', 'SVSFIsFilename',
    'DISPID_SVSLastStreamNumberQueued', 'SPPARTOFSPEECH',
    'SAFT12kHz8BitMono', 'DISPID_SRSAudioStatus',
    'DISPID_SDKEnumValues', 'DISPID_SPPValue',
    'DISPID_SGRAddResource', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRRDiscardResultInfo', 'DISPIDSPTSI_SelectionLength',
    'LONG_PTR', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPBO_NONE',
    'DISPID_SPRuleChildren', 'DISPID_SVGetProfiles',
    'DISPID_SPACommit', 'SGLexical', 'DISPID_SPPEngineConfidence',
    'DISPID_SWFEBitsPerSample', 'DISPID_SVEWord',
    'DISPID_SGRSTs_NewEnum', 'SPEVENTENUM', 'SECLowConfidence',
    'ISpeechLexicon', 'SPSHT_Unknown', 'SpPhraseInfoBuilder',
    ...
    'SPINTERFERENCE_NONE', 'SGRSTTWildcard', 'SAFT12kHz8BitStereo',
    'DISPID_SVStatus', 'DISPID_SpeechPhraseAlternate',
    'SpeechCategoryRecoProfiles', 'SPINTERFERENCE_NOSIGNAL',
    'eLEXTYPE_PRIVATE6', 'ISpMMSysAudio', 'SPBINARYGRAMMAR',
    'SPEI_PHRASE_START', 'SITooFast', 'ISpeechRecoGrammar',
    'DISPID_SRCEHypothesis', 'DISPID_SRGId', 'SPEI_RESERVED5',
    'DISPID_SMSSetData', 'SRTReSent', 'SRADynamic', 'SP_VISEME_10',
    'SAFT11kHz8BitStereo', 'SPWT_LEXICAL', 'SPBO_AHEAD',
    'SAFTExtendedAudioFormat', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechDataKey', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRRGetXMLErrorInfo', 'SPSEMANTICERRORINFO',
    'DISPID_SPRFirstElement', 'DISPID_SVSLastBookmarkId',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPISaveToMemory',
    'SPSLMA', 'DISPID_SGRSTText', 'ISpNotifySource',
    'SpeechTokenKeyAttributes', 'SPAS_STOP', 'DISPID_SPPParent',
    'DISPID_SGRSTPropertyName', 'DISPID_SLPSymbolic',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRRecognizer',
    'SAFT22kHz16BitMono', 'SPAUDIOOPTIONS', 'SP_VISEME_9',
    'DISPID_SPPId', 'SVSFParseSapi', 'SRSInactiveWithPurge',
    'SpeechSpecialTransitionType', 'SpeechRunState',
    'ISpPhoneticAlphabetConverter', 'ISpeechPhraseAlternate',
    'DISPID_SVResume', 'SpeechCategoryAppLexicons', 'DISPID_SFSClose',
    'ISpRecognizer', 'SAFTGSM610_11kHzMono', 'SREBookmark',
    'SAFT8kHz16BitMono', 'SDKLCurrentUser', 'SPSInterjection',
    'SPBO_TIME_UNITS', 'DISPID_SPPConfidence', 'SVEWordBoundary',
    'SpNotifyTranslator', 'DISPID_SPRText', 'SVP_6',
    'ISpeechPhraseProperties', 'DISPID_SRCCreateResultFromMemory',
    'ISpStreamFormat', 'SPPS_Interjection', 'SGSExclusive',
    'SpeechDisplayAttributes', 'SPFM_OPEN_READONLY', 'tagSTATSTG',
    'SpNullPhoneConverter', 'SPEVENT', 'SPSHT_EMAIL',
    'DISPID_SRCEEndStream', 'DISPID_SOTCDefault', 'SPBOOKMARKOPTIONS',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SVEventInterests',
    'DISPID_SRGDictationUnload', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCEAdaptation', 'SPPS_Verb',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SpeechRecoContextEvents',
    'SAFTCCITT_uLaw_44kHzStereo', 'SVP_5', 'ISpAudio', 'SLTApp',
    'DISPID_SpeechPhraseBuilder', 'ISpObjectWithToken', 'SP_VISEME_7',
    'DISPID_SLWs_NewEnum', 'SpeechTokenShellFolder',
    'eLEXTYPE_PRIVATE16', 'SpeechGrammarTagUnlimitedDictation',
    'SP_VISEME_0', 'SpeechFormatType', 'DISPID_SGRAddState',
    'SPGS_EXCLUSIVE', 'SpeechRegistryLocalMachineRoot',
    'SAFT8kHz8BitMono', 'SECFDefault', 'DISPID_SOTGetDescription',
    'SPGS_ENABLED', 'SP_VISEME_21', 'ISpeechPhoneConverter',
    'SPXRO_SML', 'DISPID_SRRAudioFormat', 'ISpeechRecoResult2',
    'SGRSTTRule', 'DISPID_SGRSTsItem', 'DISPID_SRStatus',
    'SRESoundStart', 'ISpRecognizer2', 'SVSFParseAutodetect',
    'SVF_Stressed', 'DISPID_SLWsCount', 'DISPID_SAStatus',
    'DISPID_SRCCreateGrammar', 'DISPID_SOTCId',
    'SPADAPTATIONRELEVANCE', 'SPEI_TTS_PRIVATE',
    'SAFTCCITT_ALaw_44kHzMono', 'SpWaveFormatEx', 'SRTEmulated',
    'SP_VISEME_12', 'ISpeechVoiceStatus', 'SPAR_Unknown',
    'SpeechVisemeFeature', 'SVEPhoneme', 'ISpeechObjectTokens',
    'Speech_StreamPos_RealTime', 'DISPID_SGRsAdd', 'SINoise',
    'DISPID_SLGetGenerationChange', 'SVSFPurgeBeforeSpeak',
    'SITooQuiet', 'DISPID_SLPLangId', 'SpeechAudioState',
    'DISPID_SVEAudioLevel', 'DISPID_SpeechVoiceStatus',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SOTCGetDataKey',
    'SGDSActive', 'SAFT8kHz16BitStereo', 'eLEXTYPE_PRIVATE12',
    'DISPID_SpeechAudioStatus', 'SVP_19', 'DISPID_SGRClear',
    'SITooLoud', 'DISPID_SRCESoundEnd', 'SAFTText', 'SVSFIsNotXML',
    'SPRS_ACTIVE', 'SREFalseRecognition', 'SPFM_OPEN_READWRITE',
    'SDTProperty', 'STSF_AppData', 'DISPID_SVSyncronousSpeakTimeout',
    'SSFMCreateForWrite', 'DISPID_SpeechAudioBufferInfo',
    'SRTExtendableParse', 'SAFT44kHz16BitMono',
    'SpeechGrammarTagDictation', 'SPAO_RETAIN_AUDIO',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRATopLevel',
    'SVSFParseSsml', 'SPEI_UNDEFINED', 'SRESoundEnd', 'SVPNormal',
    'DISPID_SOTRemove', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPRST_INACTIVE_WITH_PURGE', 'SPGRAMMARSTATE', 'DISPID_SLPsItem',
    'SVEStartInputStream', 'SPEI_FALSE_RECOGNITION',
    'SpeechVoiceSpeakFlags', 'Speech_Default_Weight',
    'eLEXTYPE_PRIVATE19', 'SP_VISEME_17', 'DISPID_SPIStartTime',
    'SVSFIsXML', 'DISPID_SWFEFormatTag', 'DISPID_SPAs_NewEnum',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'eLEXTYPE_PRIVATE17',
    'SAFT32kHz8BitStereo', 'SVP_17', '_ISpeechVoiceEvents',
    'SpeechCategoryPhoneConverters', 'SPPS_NotOverriden',
    'ISpeechMMSysAudio', 'DISPID_SLGetWords', 'DISPID_SGRSTWeight',
    'SPPHRASE', 'DISPID_SPCPhoneToId', 'SPAO_NONE',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPIAudioSizeTime',
    'STCInprocServer', 'DISPID_SPPName', 'SPDKL_CurrentUser',
    ...
    'DISPID_SOTId', 'SP_VISEME_5', 'SPWF_SRENGINE',
    'DISPID_SRRSaveToMemory', 'SWTAdded', 'DISPID_SPEAudioTimeOffset',
    'SDKLCurrentConfig', 'WAVEFORMATEX', 'SPPHRASEELEMENT',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechGrammarRules',
    'DISPID_SVSVisemeId', 'DISPID_SRCCmdMaxAlternates',
    'SPEI_RESERVED3', 'SASPause', 'DISPID_SLWWord',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRRAlternates',
    'DISPID_SVSkip', 'DISPID_SPEsCount', 'SREAllEvents',
    'DISPID_SRCEFalseRecognition', 'DISPID_SGRsCommitAndSave',
    'SpeechBookmarkOptions', 'SFTSREngine',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechLexiconWord',
    'SpeechCategoryAudioOut', 'SVF_None', 'SPPS_Unknown',
    'DISPID_SVEEnginePrivate', 'SPAS_PAUSE', 'eLEXTYPE_USER_SHORTCUT',
    'SP_VISEME_6', 'DISPID_SVGetVoices', 'DISPID_SpeechPhraseRules',
    'DISPID_SVSPhonemeId', 'DISPID_SGRInitialState',
    'SpeechRegistryUserRoot', 'SpeechRuleAttributes',
    'eLEXTYPE_RESERVED6', 'DISPID_SRGCmdSetRuleState', 'SGRSTTWord',
    'DISPID_SOTGetAttribute', 'DISPID_SDKSetStringValue',
    'ISpRecoResult', 'eLEXTYPE_PRIVATE13', 'DISPID_SPPFirstElement',
    'SVP_13', 'SRAONone', 'SpeechRuleState', 'SFTInput',
    'DISPID_SpeechWaveFormatEx', 'ISpeechWaveFormatEx', 'SPVISEMES',
    'SpeechEngineProperties', 'SREStreamEnd',
    'DISPID_SpeechRecoResult', 'SAFTDefault', 'ISpeechAudio',
    'SPEI_ADAPTATION', 'DISPID_SVEViseme', 'DISPID_SRCPause',
    'DISPID_SPRsCount', 'SPVPRI_ALERT', 'SPLEXICONTYPE',
    'SpeechRetainedAudioOptions',
    'DISPID_SPANumberOfElementsInResult', 'SpeechCategoryVoices',
    'DISPID_SOTs_NewEnum', 'DISPID_SGRs_NewEnum',
    'SpPhoneticAlphabetConverter', 'SPXMLRESULTOPTIONS',
    'SAFTADPCM_8kHzStereo', 'DISPID_SCSBaseStream',
    'DISPID_SGRSAddWordTransition', 'SpSharedRecoContext',
    'SRADefaultToActive', 'SPEI_PHONEME', 'DISPID_SPRulesCount',
    'DISPID_SPRsItem', 'SPCONTEXTSTATE', 'DISPID_SPPChildren',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVEStreamStart',
    'SPSModifier', 'SPSEMANTICFORMAT', 'SP_VISEME_16',
    'DISPID_SRState', 'SpCustomStream', 'SRSActive',
    '_RemotableHandle', 'SP_VISEME_3', 'SAFTGSM610_44kHzMono',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPEI_HYPOTHESIS',
    'DISPID_SRCEBookmark', 'ISpProperties', 'SpStreamFormatConverter',
    'DISPID_SRIsShared', 'DISPID_SPRs_NewEnum', 'SPWORDPRONOUNCEABLE',
    'SVSFNLPSpeakPunc', 'DISPID_SGRSTPropertyValue', 'SP_VISEME_11',
    'SpMemoryStream', 'SAFT24kHz8BitStereo', 'DISPID_SpeechLexicon',
    'SRTSMLTimeout', 'DISPID_SRRTStreamTime',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPCLangId', 'SPAUDIOSTATE',
    'DISPID_SRCSetAdaptationData', 'DISPID_SPAsItem',
    'DISPID_SPIProperties', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SDKGetBinaryValue', 'DISPID_SGRsCount', 'SPEI_MIN_TTS',
    'DISPID_SRCResume', 'SpInProcRecoContext', 'SPPS_RESERVED1',
    'SAFT22kHz8BitMono', 'DISPID_SRGDictationSetState',
    'DISPID_SOTsCount', 'DISPID_SWFEChannels', 'SPEI_SR_BOOKMARK',
    'SPRST_INACTIVE', 'eLEXTYPE_PRIVATE2', 'SAFT48kHz8BitStereo',
    'ISpLexicon', 'DISPIDSPTSI', 'DISPID_SDKCreateKey',
    'SpeechPropertyNormalConfidenceThreshold', 'SPWORD',
    'SPVPRIORITY', 'ISpRecoCategory', 'SpObjectToken',
    'SPDKL_LocalMachine', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTGSM610_22kHzMono', 'DISPID_SGRSTNextState',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVWaitUntilDone',
    'ISpeechRecognizerStatus', 'SECFIgnoreCase', 'SPEVENTSOURCEINFO',
    'DISPID_SBSFormat', 'DISPID_SABufferInfo', 'SPWAVEFORMATTYPE',
    'SREPhraseStart', 'DISPID_SRGetPropertyString',
    'SpCompressedLexicon', 'SWPUnknownWordUnpronounceable',
    'SREPropertyNumChange', 'SPCT_COMMAND', 'DISPID_SPARecoResult',
    'DISPID_SABIMinNotification',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPRuleName',
    'SAFT16kHz8BitMono', 'DISPID_SRSSupportedLanguages',
    'DISPID_SADefaultFormat', 'DISPID_SRDisplayUI',
    'DISPID_SpeechVoiceEvent', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPPNumberOfElements',
    'SpAudioFormat', 'SAFT32kHz16BitMono',
    'DISPID_SVSInputSentencePosition', 'SVF_Emphasis', 'SP_VISEME_19',
    'DISPID_SPPs_NewEnum', 'DISPIDSPRG', 'SPPS_Noncontent',
    'DISPID_SpeechXMLRecoResult', 'SDTRule', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SMSALineId', 'DISPID_SVSLastBookmark',
    'DISPID_SRCRequestedUIType', 'DISPID_SRCRetainedAudioFormat',
    'SAFT11kHz16BitStereo', 'DISPID_SRCERequestUI', 'SPRECOSTATE',
    'SpeechLoadOption', 'DISPID_SLPPhoneIds',
    'DISPID_SpeechGrammarRuleState', 'SGSDisabled',
    'SECFNoSpecialChars', 'SVSFParseMask', 'SGDSInactive',
    'DISPID_SRGetPropertyNumber', 'SAFT16kHz16BitStereo',
    'SpeechTokenKeyFiles', 'SPEI_SR_AUDIO_LEVEL', 'eLEXTYPE_PRIVATE4',
    'SpeechTokenIdUserLexicon', 'SPBO_PAUSE',
    'ISpeechRecoResultTimes', 'SDTPronunciation',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPSVerb',
    'DISPID_SMSADeviceId', 'SPXRO_Alternates_SML',
    'SpResourceManager', 'SPEI_MAX_SR', 'ISpeechResourceLoader',
    'SGRSTTDictation', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechLexiconProns', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPIGetDisplayAttributes', 'SPSHORTCUTTYPE',
    'SDA_No_Trailing_Space', 'SREPrivate', 'SPEI_MIN_SR',
    'SVSFlagsAsync', 'SpMMAudioEnum', 'DISPID_SBSRead',
    'SAFTADPCM_11kHzMono', 'DISPID_SPEAudioSizeBytes', 'SPRST_ACTIVE',
    'SAFT32kHz16BitStereo', 'DISPID_SRSCurrentStreamNumber',
    'SpUnCompressedLexicon', '_SPAUDIOSTATE',
    'DISPID_SPEPronunciation', 'SASRun', 'eLEXTYPE_PRIVATE18',
    'SLOStatic', 'ISpeechGrammarRules', 'ISpeechFileStream',
    'ISpObjectToken', 'SPSTREAMFORMATTYPE', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPEDisplayAttributes', 'DISPID_SPPsCount',
    'DISPID_SOTRemoveStorageFileName', 'SPEI_SENTENCE_BOUNDARY',
    'STCInprocHandler', 'SDKLDefaultLocation',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTADPCM_22kHzMono',
    'SpeechWordType', 'SITooSlow', 'SpeechPartOfSpeech',
    'SP_VISEME_1', 'SPSERIALIZEDPHRASE',
    'DISPID_SpeechObjectTokenCategory', 'SAFTADPCM_22kHzStereo',
    'DISPID_SRCVoice', 'SPCT_SUB_DICTATION', 'SRAORetainAudio',
    'DISPID_SGRSTransitions', 'SGDSActiveUserDelimited',
    'DISPID_SPEActualConfidence', 'DISPID_SpeechVoice',
    'DISPID_SPILanguageId', 'ISpeechPhraseInfo',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechCustomStream',
    'eLEXTYPE_PRIVATE11', 'ISpPhraseAlt', 'SPPS_RESERVED4',
    'ISpeechRecognizer', 'SAFT24kHz8BitMono', 'DISPID_SBSSeek',
    'ISpPhrase', 'SPFM_CREATE', 'DISPID_SRCEPropertyNumberChange',
    'SpeechDataKeyLocation', 'eLEXTYPE_PRIVATE1', 'SVSFVoiceMask',
    'ISpeechMemoryStream', 'tagSPPROPERTYINFO',
    'SpeechWordPronounceable', 'SPEI_SR_PRIVATE',
    'SREPropertyStringChange', 'SSTTWildcard', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechAudio', 'ISpeechAudioFormat', 'ISpeechRecoResult',
    'SGRSTTTextBuffer', 'SRERecoOtherContext', 'SPEI_TTS_AUDIO_LEVEL',
    'SPSHORTCUTPAIRLIST', 'DISPID_SDKEnumKeys', 'DISPID_SGRsFindRule',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SRCEventInterests',
    'SDTAudio', 'SPCT_DICTATION', 'SPDKL_CurrentConfig',
    'SpeechCategoryAudioIn', 'SPAR_High', 'SVP_11', 'SPPHRASERULE',
    'DISPID_SRRAudio', 'DISPID_SPEs_NewEnum', 'SPPS_SuppressWord',
    'SPEI_RECOGNITION', 'DISPID_SPELexicalForm', 'DISPID_SLWLangId',
    'DISPID_SOTGetStorageFileName', 'SpeechRecognitionType',
    'DISPID_SpeechRecoResult2', 'SPPS_RESERVED2', 'SVSFUnusedFlags',
    'DISPID_SPRuleParent', 'DISPID_SRCESoundStart', 'SPWORDLIST',
    'DISPID_SGRSTType', 'SAFT48kHz8BitMono',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SDKGetlongValue',
    'DISPID_SPAPhraseInfo', 'SDKLLocalMachine', 'eWORDTYPE_DELETED',
    'DISPID_SOTCategory', 'DISPID_SASetState', 'SPPHRASEPROPERTY',
    'DISPID_SASFreeBufferSpace', 'SPINTERFERENCE_TOOFAST',
    'SAFTCCITT_ALaw_8kHzMono', 'IEnumSpObjectTokens',
    'eLEXTYPE_RESERVED10', 'SPAS_CLOSED',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVSpeakStream',
    'DISPID_SRRTTickCount', 'SVP_4', 'DISPID_SLWType',
    'DISPID_SpeechPhraseAlternates', 'ISpeechPhraseAlternates',
    'DISPID_SRGReset', 'SSTTDictation', 'SPVOICESTATUS',
    'DISPID_SPCIdToPhone', 'DISPID_SWFEExtraData', 'SRAExport',
    'SREStreamStart', 'DISPID_SpeechPhraseElement', 'SVP_9',
    'DISPID_SVRate', 'DISPID_SpeechLexiconWords',
    'DISPIDSPTSI_ActiveLength', '_ISpeechRecoContextEvents',
    'SPCATEGORYTYPE', 'DISPID_SRGDictationLoad', 'SpStream',
    'SpPhoneConverter', 'SSTTTextBuffer', 'SAFT12kHz16BitMono',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPWORDTYPE',
    'SPEI_RESERVED2', 'SpeechAudioFormatGUIDText',
    'SpeechAudioVolume', 'DISPID_SRIsUISupported', 'STCLocalServer',
    'SPSFunction', 'SPFILEMODE', 'SPWORDPRONUNCIATIONLIST',
    'SGRSTTEpsilon', 'DISPID_SDKGetStringValue',
    'DISPID_SMSAMMHandle', 'DISPID_SPPsItem', 'DISPID_SAFGuid',
    'eLEXTYPE_PRIVATE3', 'STSF_FlagCreate', 'eLEXTYPE_APP',
    'SPAR_Low', 'SPEI_PROPERTY_STRING_CHANGE', 'SBONone', 'SVP_21',
    'DISPID_SLWsItem', 'DISPID_SGRName', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRRGetXMLResult', 'ISpeechPhraseElements',
    'DISPID_SWFEBlockAlign', 'ISpEventSink',
    'DISPID_SLWPronunciations', 'SPINTERFERENCE_LATENCY_WARNING',
    'eLEXTYPE_PRIVATE9', 'SpeechVoiceCategoryTTSRate',
    'SAFT44kHz8BitMono', 'DISPID_SRCRecognizer',
    'DISPID_SpeechGrammarRule', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPIGrammarId', 'SPEI_END_INPUT_STREAM', 'DISPID_SPIRule',
    'DISPID_SAEventHandle', 'DISPID_SMSGetData',
    'DISPID_SPERequiredConfidence', 'SpeechGrammarTagWildcard',
    'SVEAllEvents', 'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SVPriority',
    'SPAUDIOBUFFERINFO', 'SLODynamic', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SpeechPhraseProperties', 'SpeechEmulationCompareFlags',
    'SpeechPropertyResourceUsage', 'DISPID_SRSetPropertyString',
    'SVEAudioLevel', 'DISPID_SVSLastResult', 'SAFTADPCM_44kHzStereo',
    'DISPID_SABIEventBias', 'SECHighConfidence',
    'DISPID_SPIReplacements', 'SPEI_INTERFERENCE',
    'SPEI_RECO_STATE_CHANGE', 'IStream', 'DISPID_SDKDeleteValue',
    'ISpeechPhraseElement', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechPhoneConverter', 'SWTDeleted', 'SpeechTokenKeyUI',
    'SLTUser', 'ISpRecoGrammar', 'DISPID_SVPause', 'SINoSignal',
    'DISPID_SPRulesItem', 'SPSHT_OTHER', 'SVP_12',
    'SPGRAMMARWORDTYPE', 'DISPID_SLPs_NewEnum', 'SGPronounciation',
    'SVP_18', 'DISPID_SVSRunningState', 'SREAdaptation',
    'SpeechGrammarWordType', 'DISPID_SpeechRecoContext',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPIGetText', 'ISpRecognizer3',
    'SpeechTokenContext', 'DISPID_SVSInputWordPosition', 'SPPS_Noun',
    'SDTAlternates', 'SPSHORTCUTPAIR', 'ISpeechLexiconPronunciation',
    'ISpeechObjectTokenCategory', 'SPDKL_DefaultLocation',
    'tagSPTEXTSELECTIONINFO', 'Speech_StreamPos_Asap',
    'SAFT32kHz8BitMono', 'ISpNotifySink', 'SPRULE', 'SDTDisplayText',
    'ISpeechPhraseRules', 'SPRULESTATE', 'ISpShortcut',
    'SAFT24kHz16BitStereo', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SAFT11kHz8BitMono', 'SVPAlert', 'SDA_Two_Trailing_Spaces',
    'SDA_One_Trailing_Space', 'SPINTERFERENCE',
    'DISPID_SpeechLexiconPronunciation', 'SAFTADPCM_11kHzStereo',
    'SPSSuppressWord', 'DISPID_SOTMatchesAttributes',
    'DISPID_SVDisplayUI', 'ISpeechRecoResultDispatch', 'SVP_7',
    'DISPID_SpeechFileStream', 'STCAll', 'SVP_15', 'DISPID_SRGState',
    'SRERequestUI', 'SPVPRI_OVER', 'SpVoice', 'SPEI_REQUEST_UI',
    'DISPID_SPEEngineConfidence', 'DISPID_SGRsDynamic',
    'DISPID_SRCState', 'DISPID_SPIEnginePrivateData',
    'SSFMOpenForRead', 'DISPID_SPRuleConfidence', 'SPLO_DYNAMIC',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SpeechAudioProperties', 'DISPID_SPEsItem',
    'DISPID_SABIBufferSize', 'SECFEmulateResult', 'SpeechMicTraining',
    'DISPID_SGRSTRule', 'DISPID_SGRAttributes', 'ISpPhoneConverter',
    'SVEEndInputStream', 'SAFT16kHz16BitMono',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SVP_0', 'SPAS_RUN',
    'eLEXTYPE_USER', 'ISpStream', 'DISPID_SVEBookmark',
    'DISPID_SLPPartOfSpeech', 'SREHypothesis', 'ISpeechRecoContext',
    'SPCS_ENABLED', 'SPRS_INACTIVE', 'SPEI_MAX_TTS',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechDataKey',
    'SPEI_START_SR_STREAM', 'SVESentenceBoundary',
    'DISPID_SGRSTPropertyId', 'SP_VISEME_14',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPWORDPRONUNCIATION',
    'DISPID_SRCERecognition', 'DISPID_SDKOpenKey',
    'SAFT24kHz16BitMono', 'ISpeechPhraseProperty',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SGRsItem', 'SRARoot',
    'SECFIgnoreWidth', 'SPRST_NUM_STATES', 'DISPID_SRRSpeakAudio',
    'DISPID_SRProfile', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpLexicon',
    'DISPID_SPIElements', 'SPWF_INPUT', 'ISpeechPhraseRule',
    'DISPID_SAFType', 'DISPID_SGRSTsCount',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_SOUND_START',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCEAudioLevel',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVAudioOutputStream', 'SSFMCreate',
    'SPINTERFERENCE_TOOSLOW', 'SpeechPropertyAdaptationOn',
    'DISPID_SGRId', 'SRSEDone', 'SAFT8kHz8BitStereo',
    'DISPID_SVVoice', 'ISpPhoneticAlphabetSelection',
    'eLEXTYPE_RESERVED9', 'DISPID_SRGRules',
    'ISpeechPhraseInfoBuilder', 'DISPID_SDKSetBinaryValue',
    ...
    'SpeechVoiceSkipTypeSentence', 'ISpeechAudioStatus',
    'ISequentialStream', 'DISPID_SPRuleId', 'SRTStandard',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCBookmark',
    'DISPID_SRAudioInputStream', 'UINT_PTR', 'SP_VISEME_13',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SWFESamplesPerSec',
    'SASClosed', 'ISpeechXMLRecoResult', 'ISpXMLRecoResult',
    'SpeechAllElements', 'SpeechTokenValueCLSID',
    'SpeechPropertyHighConfidenceThreshold', 'ISpEventSource',
    'DISPID_SVGetAudioOutputs', 'DISPID_SVGetAudioInputs',
    'SPEI_WORD_BOUNDARY', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRSNumberOfActiveRules', 'SVEPrivate',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SGRSRule', 'SpeechGrammarState', 'DISPID_SVVolume',
    'SPCT_SUB_COMMAND', 'SDA_Consume_Leading_Spaces',
    'DISPID_SPERetainedStreamOffset', 'SpeechVisemeType',
    'DISPID_SLRemovePronunciation', 'SVP_16', 'DISPID_SPEDisplayText',
    'SpeechRecognizerState', 'SPPS_Modifier',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SRRTimes',
    'DISPID_SVEStreamEnd', 'DISPID_SREmulateRecognition',
    'DISPID_SPAsCount', 'SAFT22kHz16BitStereo', 'SpMMAudioIn',
    'DISPID_SRGetRecognizers', 'SPCS_DISABLED',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPSERIALIZEDRESULT',
    'IInternetSecurityManager', 'SREAudioLevel', 'STSF_LocalAppData',
    'SGSEnabled', 'eLEXTYPE_PRIVATE20', 'SSSPTRelativeToStart',
    'DISPID_SOTCreateInstance', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechDiscardType', 'SAFTGSM610_8kHzMono', 'SAFT16kHz8BitStereo',
    'SREStateChange', 'DISPID_SVESentenceBoundary',
    'SpObjectTokenCategory', 'SP_VISEME_2',
    'ISpStreamFormatConverter', 'DISPID_SpeechBaseStream',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SPRules_NewEnum',
    'ISpeechGrammarRuleStateTransitions', 'SRCS_Enabled',
    'SpeechLexiconType', 'eLEXTYPE_RESERVED7', 'DISPID_SOTCSetId',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SRGIsPronounceable',
    'SPSUnknown', 'SPAR_Medium', 'IInternetSecurityMgrSite',
    'SPGS_DISABLED', 'ISpNotifyTranslator', 'SVEBookmark',
    'SVSFNLPMask', 'DISPID_SASNonBlockingIO', 'eLEXTYPE_PRIVATE7',
    'ISpSerializeState', 'SPFM_NUM_MODES', 'SpFileStream'
]
